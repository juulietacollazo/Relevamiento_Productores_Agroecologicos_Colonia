...
map.getView().fit([-6491314.722289, -4109646.230391, -6368591.959007, -3973645.199593], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Relevamiento de productores agroecológicos en el departamento de Colonia</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Actoresenterritorio_2,
    colName: 'NOMBRE',
    zoom: 10,
    collapsed: true,
    map: map
